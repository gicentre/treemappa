...
public class XML15 implements AbstractXML
{
	// ---------------------------------- Object variables ----------------------------------
	 ...
	 */
	public XML15(PApplet parent, String fileName)
	{
		this(new XMLElement(parent,fileName));
	}
	
	/** Creates a new abstracted XML element from the given Processing 1.5 XMLElement object.
	 *  @param xml XML object to be wrapped by this version-neutral abstraction.
	 */
	public XML15(XMLElement xml)
	{
		this.xml = xml;
	}
	...
	public AbstractXML[] getChildren() 
	{
		...
		{
			aChildren[i] = new XML15(children[i]);
		}
		return aChildren;
	}
