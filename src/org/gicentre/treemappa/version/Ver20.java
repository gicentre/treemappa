...
public class Ver20 implements VersionHandler
{
	// ---------------------------------- Object variables ----------------------------------
	 ...
	 */
	public Ver20(PApplet parent)
	{
		this.parent = parent;
		
		// Make a Processing 2.0 specific call to check this is the right implementation.
		@SuppressWarnings("unused")
		processing.data.XML e;
	}
	...
	{
		return new XML20(sketch,fileName);
	}
}
